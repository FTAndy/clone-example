...
exports.getSpecialDetail = void 0;
            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, specialPage.evaluate(function () {
                            var _a;
                            return (_a = document.querySelector('[data-testid="title-details-releasedate"] .ipc-inline-list__item a')) === null || _a === void 0 ? void 0 : _a.innerHTML;
                        })];
                case 4:
                    datetime = _a.sent();
                    return [4 /*yield*/, specialPage.evaluate(function () {
                ...
                case 5:
                    netflixURL = _a.sent();
                    return [4 /*yield*/, specialPage.evaluate(function () {
                            var element = document.querySelector('[data-testid="title-techspec_runtime"] .ipc-metadata-list-item__content-container');
...
exports.getSpecialDetail = getSpecialDetail;
